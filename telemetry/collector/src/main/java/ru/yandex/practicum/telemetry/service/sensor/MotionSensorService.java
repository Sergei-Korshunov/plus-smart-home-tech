...
@Component
public class MotionSensorService extends SensorEventService {

    public MotionSensorService(KafkaClient kafkaClient, Set<SensorEventMapper> sensorEventMappers) {
