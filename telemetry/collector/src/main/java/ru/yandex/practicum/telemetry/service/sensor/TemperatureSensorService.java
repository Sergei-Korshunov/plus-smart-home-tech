...
@Component
public class TemperatureSensorService extends SensorEventService {

    public TemperatureSensorService(KafkaClient kafkaClient, Set<SensorEventMapper> sensorEventMappers) {
