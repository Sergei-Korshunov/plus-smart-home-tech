...
@Component
public class ClimateSensorService extends SensorEventService {

    public ClimateSensorService(KafkaClient kafkaClient, Set<SensorEventMapper> sensorEventMappers) {
