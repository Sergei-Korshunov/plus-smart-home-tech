...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> productNotFoundException(CartNotFoundException exception) {
        log.error(exception.getMessage());
        return ResponseEntity
    ...
    public ResponseEntity<ErrorMessage> noProductsInShoppingCartException(NoProductsInShoppingCartException exception) {
        log.error(exception.getMessage());
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(new ErrorMessage(exception, HttpStatus.BAD_REQUEST));
